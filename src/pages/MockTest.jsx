...
export default function MockTest() {
  ...
  useEffect(() => {
    ...
    document.title = 'Diagnostic Aptitude Simulation | Edwaay';
  }, []);
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#061317] text-slate-900 dark:text-[#E6F5F7] transition-colors duration-300 py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-panel p-4 rounded-2xl flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          <div>
            <h1 className="text-xl font-black text-slate-900 dark:text-white">Diagnostic Aptitude Simulation</h1>
            <p className="text-xs text-slate-500 dark:text-zinc-400 font-medium">10 Questions | 1 Minute per Question average</p>
          </div>
